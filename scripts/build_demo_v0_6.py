...
<title>AXM v0.6 Factual Technology Core Catalog</title>
<style>
...
<div class="badge">Mike — Axiom/Mir · v0.6.0</div><h1>Factual ship technology cores</h1>
...
def main() -> int:
    ...
    (tech_output / "catalog.json").write_text(json.dumps({"schema":"axm.v0.6-technology-core-demo.v1","generator_version":"0.6.0","cores":rows}, indent=2, ensure_ascii=False)+"\n", encoding="utf-8")
    ...
    summary = {"schema":"axm.v0.6-contact-horizon-demo.v1","locked":locked,"eligible":eligible,"after_first_search":after,"event":event,"ledger_valid":valid}
