...
BUILD = Path("scripts/build_demo_v0_7.py")
...
"""
    ...
    if source.count(old_call) != 1:
        raise RuntimeError(f"Expected one Contact Horizon render call, found {source.count(old_call)}")
